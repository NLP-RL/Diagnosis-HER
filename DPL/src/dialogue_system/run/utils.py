...
def construct_info(params):
    ...
    checkpoint_path = "./../../../../Diagnosis_HER_Results/model/" + dqn_type + "/checkpoint/" + info
    params["checkpoint_path"] = checkpoint_path

    performance_save_path = "./../../../..//Diagnosis_HER_Results/model/" + dqn_type + "/performance_new/"
    params["performance_save_path"] = performance_save_path

    visit_save_path = "./../../../..//Diagnosis_HER_Results/model/" + dqn_type + "/visit/"
